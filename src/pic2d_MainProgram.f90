     ...
     !t10 = MPI_WTIME()
      ...
      IF (n_sub.EQ.N_subcycles .AND. i_freeze_ions==0) THEN            ! N_subcycles is odd
        ...
        CALL PERFORM_ION_NEUTRAL_COLLISION ! new ion-neutral collision model
         ...
         ! CALL CONST_DENSITY_IONIZATION ! needs to be called after COLLECT_PARTICLE_BOUNDARY_HITS
        CALL CONST_DENSITY_IONIZATION_SURFACE ! needs to be called after COLLECT_PARTICLE_BOUNDARY_HITS
        ! CALL CONST_TEMPERATURE
